...
Your task is to determine whether it is possible to represent n burles in coins, i.e. whether there exist non-negative integers x and y such that:
...
// My first approach  - Brute force pehle check karo 2 ya k se pura pura divisible hai to     ahi ahi to k minus karte rahio aur 2 se check karte raho    but  TLE
